...
public:
  ...
  RC update_record(Trx *trx, Record *old_rec, Record *new_rec);
  ...
  RC create_index(Trx *trx, const char *index_name, char * const attribute_name[], int attribute_num, int unique);
